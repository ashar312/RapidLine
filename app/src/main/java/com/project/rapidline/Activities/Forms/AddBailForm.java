...
//                activityAddBailFormBinding.kindSpinner.setSelection(bailEditUpdate.getKindId());
        ...
        saeedSonsViewModel.getListAllCities(this).observe(this,cities -> {
            ...
            cityList.add(0, new Cities("Select a city"));

            ArrayAdapter<Cities> cityArrayAdapter = new ArrayAdapter<>(AddBailForm.this,
                    R.layout.spinner_item, cityList);
            cityArrayAdapter.setDropDownViewResource(R.layout.spinner_item);

            activityAddBailFormBinding.fromSpinner.setAdapter(cityArrayAdapter);
            activityAddBailFormBinding.toSpinner.setAdapter(cityArrayAdapter);
