package com.project.rapidline.Activities.ViewData.SaeedSons;
...
import com.project.rapidline.Activities.AdminRightsActivity;
import com.project.rapidline.Activities.Login;
import com.project.rapidline.Activities.SettingsActivity;
import com.project.rapidline.Activities.ViewBailsActivity;
...
//        });
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        switch (menuItem.getItemId()) {
            case R.id.add_bail:
                boolean add_bail_state = this.getSharedPreferences("MyPref", MODE_PRIVATE).getBoolean("add_bail_perm", true);
                if (add_bail_state) {
